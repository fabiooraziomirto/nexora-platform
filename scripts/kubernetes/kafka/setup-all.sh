...
echo "📦 Setting up Cache & Message Broker infrastructure for Nxr v2.0"
...
echo "📝 Next steps:"
echo "  1. Verify Redis:"
echo "     kubectl exec -it redis-master-0 -n nxr-infrastructure -- redis-cli -a redispassword PING"
echo ""
