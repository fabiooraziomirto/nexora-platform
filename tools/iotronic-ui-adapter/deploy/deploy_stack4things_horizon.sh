...
echo "[INFO] Copying Stack4Things IoTronic adapter..."
cp "$SRC_ROOT/iotronic_ui/api/iotronic.py" "$HORIZON_API_DIR/iotronic.py"
cp "$SRC_ROOT/iotronic_ui/enabled/_60"* "$HORIZON_ENABLED_DIR/"
